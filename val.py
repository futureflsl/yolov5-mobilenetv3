...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='/home/fut/Downloads/tieta-test-voc/animal-test-voc/voc.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'pre-model/yolov5s.pt', help='model.pt path(s)')
